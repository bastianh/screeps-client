...
function RuinDetails(props: { item: SelectedObject }) {
  ...
  // ticksToDecay: official API countdown field (already ticks remaining)
  // decay: absolute future game tick (subtract current tick to get countdown)
  // Falls back to showing raw value when gameTime not yet available (reactive: recomputes on tick)
